    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center w-[100vw] h-[100vh]">
                <NavBar />
                <p className="text-5xl font-bold text-center mt-[5vh] text-black">Welcome to SHAPE</p>
                ...
                <div className="flex items-center justify-around w-full flex-wrap gap-4">
                    ...
                    <div className={`${boxStyle} flex items-center justify-center overflow-hidden p-[4vh]`}>
