...
public class QuestionnaireService {
  ...
  /**
   * Processes the answers submitted by the user and returns a list of recommendations.
   * If the answers are not in the pool of answers, then they indicate that the user is
   ...
   * @return RecommendationsResponse containing a list of recommendations based on the user's answers.
   */
  public RecommendationsResponse processAnswersAndGetRecommendations(SubmissionRequestBodyDto answerSubmissionRequest) {
    
    //Answers that indicate little-no struggle
    Map<String, Set<Integer>> acceptableAnswers = new HashMap<>();
